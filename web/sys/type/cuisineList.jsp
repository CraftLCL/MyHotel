...
<body>
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath}/foodType?method=findByName" method="post">
	...
	<div id="MainArea">
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="${pageContext.request.contextPath}/sys/type/saveCuisine.jsp">添加</a>
			</div>
		</div>
	</div>
</body>
